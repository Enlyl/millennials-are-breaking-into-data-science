...
SPACE_STEPS = [
    {"step": 1, "title": "Бизнес-задача", "description": "Сформулируйте цель анализа: какие факторы влияют на успех космической миссии? Определите метрики успеха (accuracy модели > 80%).",
     "lessons": ["1.1", "9.1"]},
    {"step": 2, "title": "Данные: загрузка и первичный осмотр", "description": "Загрузите датасет из 200 миссий. Посмотрите на первые строки, типы данных, количество пропусков. Выведите уникальные значения категориальных признаков.",
     "lessons": ["3.3", "3.4"]},
    {"step": 3, "title": "Очистка данных", "description": "Заполните пропуски в cost_million медианой, удалите ошибочные записи (crew_size > 7), добавьте признак decade.",
     "lessons": ["3.6", "3.7", "3.11"]},
    {"step": 4, "title": "EDA — исследовательский анализ", "description": "Постройте распределение миссий по целям, успешность по целям, тренд стоимости по годам. Найдите первые инсайты.",
     "lessons": ["6.1", "6.2", "4.2", "4.3"]},
    {"step": 5, "title": "Статистический анализ", "description": "Проверьте гипотезу: миссии на Марс дороже, чем на Луну (t-test). Постройте корреляционную матрицу. Найдите значимые корреляции.",
     "lessons": ["5.5", "5.6", "5.7", "4.6"]},
    {"step": 6, "title": "Feature Engineering", "description": "Создайте новые признаки: cost_per_finding, is_crewed, mission_efficiency. Выполните one-hot encoding для категориальных колонок.",
     "lessons": ["8.1", "8.2", "8.3"]},
    {"step": 7, "title": "Моделирование", "description": "Разделите данные на train/test (70/30). Обучите Logistic Regression и Random Forest для прогноза успеха миссии. Сравните accuracy.",
     "lessons": ["7.2", "7.4", "7.5", "7.9"]},
    {"step": 8, "title": "Оценка модели", "description": "Постройте confusion matrix для лучшей модели. Проанализируйте feature importance. Какие признаки самые важные?",
     "lessons": ["7.11", "7.12"]},
    {"step": 9, "title": "Итоговая визуализация", "description": "Создайте дашборд из 4 графиков: миссии по годам, успешность по агентствам, распределение стоимости, scatter cost vs findings.",
     "lessons": ["4.8", "4.9"]},
    {"step": 10, "title": "Выводы и оформление", "description": "Напишите итоговый отчёт из 3-5 предложений. Оформите проект как README с описанием задачи, подхода и результатов.",
     "lessons": ["9.4", "9.5"]},
]
...
GAMING_STEPS = [
    {"step": 1, "title": "Бизнес-задача", "description": "Сформулируйте цель: прогноз оттока игроков (churn). Какие факторы влияют на уход? Метрика: accuracy > 80%.",
     "lessons": ["1.1", "9.1"]},
    {"step": 2, "title": "Данные: загрузка и первичный осмотр", "description": "Загрузите датасет на 200 игроков. Проверьте пропуски, баланс классов churn, типы данных.",
     "lessons": ["3.3", "3.4"]},
    {"step": 3, "title": "Очистка данных", "description": "Заполните пропуски в last_purchase_days_ago, удалите невалидные записи, создайте категорию трат (low/medium/high).",
     "lessons": ["3.6", "3.7", "3.10"]},
    {"step": 4, "title": "EDA — исследовательский анализ", "description": "Постройте распределение трат, churn rate по уровням, связь retention и членства в гильдии.",
     "lessons": ["6.1", "6.3", "4.4", "4.5"]},
    {"step": 5, "title": "Статистический анализ", "description": "Проверьте гипотезу: отличаются ли траты churned и active игроков (t-test). Постройте корреляционную матрицу.",
     "lessons": ["5.5", "5.6", "4.6"]},
    {"step": 6, "title": "Feature Engineering", "description": "Создайте признаки: win_rate, activity_score, spent_per_session, is_whale (топ-5% трат).",
     "lessons": ["8.1", "8.2", "8.5"]},
    {"step": 7, "title": "Моделирование", "description": "Разделите на train/test. Обучите Logistic Regression и Random Forest для прогноза churn.",
     "lessons": ["7.2", "7.4", "7.5"]},
    {"step": 8, "title": "Оценка модели", "description": "Постройте confusion matrix. Выведите топ-5 важных признаков. Какие признаки самые важные?",
     "lessons": ["7.11", "7.12"]},
    {"step": 9, "title": "Финальная визуализация", "description": "Создайте дашборд из 4 графиков: churn по категориям трат, распределение уровней, активность churned vs active, сессии vs траты.",
     "lessons": ["4.8", "4.9", "6.6"]},
    {"step": 10, "title": "Выводы и оформление", "description": "Итоговый отчёт. Оформите как README: цель, данные, подход, результаты, рекомендации.",
     "lessons": ["9.4", "9.5"]},
]
