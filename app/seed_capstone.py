...
[
        {
          "speaker": "client",
          "text": "Привет! Слушай, задача серьёзная. У нас данные NASA по всем миссиям с 1960 года: 200 записей, куча параметров — бюджет, страна, тип, статус. Нужно проанализировать, почему одни миссии успешны, а другие проваливаются, и построить модель прогноза успеха. Результаты оформишь в дашборд и отчёт. Справишься?",
        },
        {
          "speaker": "me",
          "text": "Хорошо, сделаю. Если будут вопросы — спрошу у команды.",
        },
        {
          "speaker": "me",
          "text": "Я вообще не понимаю, что делать. Куда нажимать? С чего начать? Я data science только в теории видел!",
        },
        {
          "speaker": "scully",
          "text": "Спокойно, выдохни. Вот полный план проекта от начала до конца:\n\n1️⃣ Загрузи данные — CSV-файл missions.csv через pandas\n2️⃣ Очистка — убери пропуски, дубликаты, приведи типы\n3️⃣ EDA — посмотри статистику, построй графики, найди закономерности\n4️⃣ Feature Engineering — создай новые признаки (decade, log_budget, has_crew)\n5️⃣ Модель — обучи Random Forest для прогноза успеха\n6️⃣ Оценка — проверь accuracy, precision, recall, confusion matrix\n7️⃣ Feature Importance — узнай, что влияет на успех миссии\n8️⃣ Интерпретация — сформулируй 3 главных вывода\n9️⃣ Дашборд — визуализируй результаты для заказчика\n🔟 Отчёт — напиши README с описанием проекта\n\nПо каждому шагу спрашивай — объясним подробно. Ты справишься!",
        },
        {
          "speaker": "alexey",
          "text": "Скалли тебе всё разложила по полочкам! Держись, новичок — вместе разберёмся. Я хоть и шучу, но если что — подскажу 😄",
        },
        {
          "speaker": "malder",
          "text": "План выглядит логично... подозрительно логично. Будь готов к тому, что данные могут скрывать правду. Но для начала — слушайся Скалли.",
        },
        {
          "speaker": "dmitry",
          "text": "Первый проект — как первое свидание! Страшно, волнительно, но потом втянешься и будет кайф. Главное — первый шаг сделать! 😉",
        },
      ]
...
,
  ...
  {
  "step": 2,
  "title": "Данные: загрузка и первичный осмотр",
  "dialogue": 
[
        {
          "speaker": "me",
          "text": "Ребята, босс прислал CSV. Как загрузить? Я только pd.read_csv помню...",
        },
        {
          "speaker": "scully",
          "text": "pd.read_csv(\"missions.csv\", encoding=\"utf-8\"). Проверь df.info() — смотри типы колонок. Если object вместо int — потом разберёмся.",
        },
        {
          "speaker": "alexey",
          "text": "Главное — encoding не забудь! А то вместо \"Юпитер\" будет \"Рпйтеп\" 😄",
        },
      ]
,
...
[
        {
          "speaker": "me",
          "text": "Загрузил. Пропуски в бюджете, статусы кривые. Чё делать?",
        },
        {
          "speaker": "scully",
          "text": "Пропусков <5% — удаляй строки. Если больше — fillna медианой по группе. Статусы приведи к lowercase и проверь уникальные значения.",
        },
        {
          "speaker": "malder",
          "text": "А ты уверен, что данные настоящие? NASA могла подделать часть. Проверь: если бюджет-успех коррелирует подозрительно идеально — значит, заговор.",
        },
      ]
,
...
[
        {
          "speaker": "me",
          "text": "Почистил. Теперь что смотреть? Гистограммы? Корреляции?",
        },
        {
          "speaker": "scully",
          "text": "Начни с describe() по числовым, value_counts() по категориям. Гистограмма budget, scatter mission_year vs cost_million, проверь баланс target.",
        },
        {
          "speaker": "alexey",
          "text": "Гистограммы скучные. Построй scatter: бюджет × успех! Спойлер: дорогие ≠ успешные. Как в жизни — дорогой ресторан не гарантирует вкус.",
        },
      ]
,
...
[
        {
          "speaker": "me",
          "text": "Какие фичи добавить? 20 колонок, но что-то мало.",
        },
        {
          "speaker": "scully",
          "text": "Создай decade из mission_year, has_crew (пилотируемые), log_budget. Для agency — target encoding, если категорий много.",
        },
        {
          "speaker": "dmitry",
          "text": "Фичи — как прелюдия. Советую признак \"романтичность\": Марс — страстно, Луна — классика, астероид — ну такое... не все миссии sexy.",
        },
      ]
,
...
[
        {
          "speaker": "me",
          "text": "Посчитал корреляции. Бюджет почти не влияет на успех?",
        },
        {
          "speaker": "scully",
          "text": "Для числовых — Pearson, но корреляция может быть нелинейной. Для категориальных — Cramér's V или ANOVA. И помни: корреляция ≠ причинность.",
        },
      ]
,
...
[
        {
          "speaker": "me",
          "text": "Дошёл до ML. Что выбрать? Я новичок в моделях.",
        },
        {
          "speaker": "scully",
          "text": "Начни с LogisticRegression — baseline. Потом RandomForestClassifier — он устойчив к переобучению и даёт feature importance. Train_test_split 80/20, stratify=y.",
        },
        {
          "speaker": "malder",
          "text": "Логистическая регрессия? Слишком предсказуемо. Хотя если миссии скрывают данные — любая модель будет гадать. Но для начала сойдёт.",
        },
      ]
,
...
[
        {
          "speaker": "me",
          "text": "Модель обучил. Accuracy 85% на трейне, 72% на тесте. Переобучение?",
        },
        {
          "speaker": "scully",
          "text": "Разрыв >10% — лёгкое переобучение. Уменьши n_estimators, ограничь max_depth. Смотри precision/recall/f1, не только accuracy. Confusion_matrix покажет реальную картину.",
        },
        {
          "speaker": "alexey",
          "text": "85% звучит круто! Но accuracy как зарплата — среднее по больнице. Смотри recall по провалам: пропустить взрыв ракеты = дороже ошибки.",
        },
      ]
,
  ...
  {
  "step": 9,
  "title": "Итоговая визуализация",
  "dialogue": 
[
        {
          "speaker": "me",
          "text": "Confusion: TN=30, FP=5, FN=20, TP=45. Много false negative.",
        },
        {
          "speaker": "scully",
          "text": "Recall низкий — модель пропускает провалы. Попробуй class_weight=\"balanced\" в Random Forest или сдвинь порог. Для космоса recall важнее: пропустить провал = потерянный спутник.",
        },
      ]
,
  ...
  {
  "step": 10,
  "title": "Выводы и оформление",
  "dialogue": 
[
        {
          "speaker": "me",
          "text": "Feature importance: cost_million на первом месте. Это логично?",
        },
        {
          "speaker": "scully",
          "text": "cost_million ожидаем: дорогие миссии часто успешны. mission_year — технологии растут. Проверь мультиколлинеарность: связанные фичи занижают importance друг друга.",
        },
      ]
,
  ...
  "task": "Опиши 3 главных вывода модели. Какие фичи важнее всего? Почему? Подготовь ответ заказчику.",
  "code": "",
  "hints": ["Вспомни, что мы обсуждали на предыдущих шагах", "Посмотри на данные с точки зрения заказчика", "Не бойся просить уточнения у коллег"],
  "lessons": [],
  "dialogue": 
[
        {
          "speaker": "me",
          "text": "Итак, три главных вывода про миссии NASA. Что сказать боссу?",
        },
        {
          "speaker": "scully",
          "text": "Три вывода: (1) Бюджет — главный фактор успеха. (2) Миссии после 2000 успешнее — технологии. (3) Пилотируемые миссии — выше риск. Подкрепи цифрами.",
        },
        {
          "speaker": "alexey",
          "text": "Добавь: \"бюджет решает, но не всё\". Даже кривая ракета долетит, если бабла хватило. Пример — Space Shuttle 😄",
        },
        {
          "speaker": "dmitry",
          "text": "И скажи: миссии-одиночки проваливаются чаще. Как и в отношениях — командная работа рулит. Экипаж — это семья!",
        },
      ]
,
},
  {
  "step": 99,
  "title": "Визуализация: дашборд",
  "task": "Построй дашборд: scatter по годам, гистограмма бюджета, круговая статусов, таблица топ-5 миссий.",
  "code": "",
  "hints": ["Вспомни, что мы обсуждали на предыдущих шагах", "Посмотри на данные с точки зрения заказчика", "Не бойся просить уточнения у коллег"],
  "lessons": [],
  "dialogue": 
[
        {
          "speaker": "me",
          "text": "Дашборд для заказчика. 4 графика достаточно?",
        },
        {
          "speaker": "alexey",
          "text": "Plotly — огонь! Сделай scatter по годам с цветом успеха, гистограмму бюджета, круговую по статусам. Чтоб заказчик ахнул!",
        },
        {
          "speaker": "malder",
          "text": "Дашборд — отвлекающий манёвр. Главное — цифры. Только без зелёного цвета: он слишком успокаивает, расслабляет бдительность заказчика.",
        },
      ]
,
},
  ...
  "step": 99,
  "title": "Отчёт README",
  "task": "Напиши README-отчёт: задача → данные → EDA → модель → результаты → выводы.",
  "code": "",
  "hints": ["Вспомни, что мы обсуждали на предыдущих шагах", "Посмотри на данные с точки зрения заказчика", "Не бойся просить уточнения у коллег"],
  "lessons": [],
  "dialogue": 
[
        {
          "speaker": "me",
          "text": "Начинаю README-отчёт. Структуру подскажете?",
        },
        {
          "speaker": "scully",
          "text": "Структура: 1) Бизнес-задача, 2) Данные и EDA, 3) Модель и метрики, 4) Feature Importance, 5) Выводы. Таблицу метрик и 2-3 ключевых графика.",
        },
        {
          "speaker": "dmitry",
          "text": "Не забудь раздел \"Что пошло не так\". Заказчики любят честность. Как в отношениях: признать ошибку > сделать вид, что всё идеально.",
        },
      ]
,
},
  ...
  "task": "Подготовь презентацию: 5 слайдов о проекте, метриках и инсайтах.",
  "code": "",
  "hints": ["Вспомни, что мы обсуждали на предыдущих шагах", "Посмотри на данные с точки зрения заказчика", "Не бойся просить уточнения у коллег"],
  "lessons": [],
  "dialogue": 
[
        {
          "speaker": "me",
          "text": "Завтра защита. Волнуюсь! Какие вопросы задают?",
        },
        {
          "speaker": "alexey",
          "text": "Не парься! Твоя модель работает. Если спросят сложное — скажи \"хороший вопрос, изучу\". Я так на каждом стендапе делаю.",
        },
        {
          "speaker": "malder",
          "text": "К защите готовься серьёзно. Заказчик спросит: \"Почему не XGBoost?\" \"А ты учёл bias в данных?\" Отвечай уверенно, даже если не уверен.",
        },
      ]
,
},
...
[
        {
          "speaker": "me",
          "text": "Босс, я закончил! Модель готова, дашборд собрал, отчёт написал.",
        },
        {
          "speaker": "client",
          "text": "Отлично! Давай посмотрим... Дашборд крутой, отчёт понятный. Модель 85% accuracy — отличный результат. Принимаю! Молодец.",
        },
        {
          "speaker": "alexey",
          "text": "Ура! 🎉 Первый проект сдан! Ты теперь не новичок, а junior с опытом!",
        },
        {
          "speaker": "scully",
          "text": "Хорошая работа. Быстро освоилась. Если хочешь — покажу продвинутые техники для следующего проекта.",
        },
        {
          "speaker": "malder",
          "text": "Заказчик подозрительно доволен... Либо проект реально хорош, либо скрывает истинную оценку. Но ты молодец.",
        },
        {
          "speaker": "dmitry",
          "text": "Поздравляю! Первый проект — как первая любовь: волнительно, страшно, но в конце — кайф!",
        },
      ]
,
},
...
[
        {
          "speaker": "client",
          "text": "Привет! У нас проблема: игроки уходят. Средний retention — неделя, а хочется месяц. Данные по 200 игрокам: уровень, траты, сессии, гильдия. Нужно понять, почему уходят, и построить модель прогноза оттока (churn). Результаты — команде разработки. Справишься?",
        },
        {
          "speaker": "me",
          "text": "Хорошо, сделаю. Если что — уточню у коллег.",
        },
        {
          "speaker": "me",
          "text": "Я в игровой аналитике ноль. Retention, churn — слова страшные. Помогите!",
        },
        {
          "speaker": "galina",
          "text": "Не паникуй. Вот полный план проекта:\n\n1️⃣ Загрузи данные — players.csv через pandas\n2️⃣ Очистка — удали пропуски, выбросы (level>100 — читеры)\n3️⃣ EDA — статистика игроков, графики трат и сессий\n4️⃣ Feature Engineering — avg_session_time, spending_per_level, has_guild\n5️⃣ Модель — Random Forest для прогноза churn\n6️⃣ Оценка — accuracy, recall по уходящим игрокам\n7️⃣ Feature Importance — что влияет на отток\n8️⃣ Интерпретация — 3 главных инсайта\n9️⃣ Дашборд — визуализация для команды\n🔟 Отчёт — README с рекомендациями\n\nСпрашивай по каждому шагу — поможем!",
        },
        {
          "speaker": "sergey",
          "text": "Галя красава, расписала! Это как пройти хардкорный квест — поэтапно, не запрыгивая в толпу мобов. Ты справишься, бро! 🎮",
        },
        {
          "speaker": "igor",
          "text": "План норм. Но будь готов, что данные всегда грязнее, чем кажутся. И модель не будет работать с первой попытки. Но это нормально.",
        },
        {
          "speaker": "stepan",
          "text": "Когда дойдёшь до дашборда — я помогу с визуалом. Цвета, компоновка — моя тема! Главное — не бойся, всё получится.",
        },
      ]
...
[
        {
          "speaker": "me",
          "text": "Ребята, файл players.csv прислали. Как открыть?",
        },
        {
          "speaker": "galina",
          "text": "pd.read_csv, encoding=\"utf-8\". Сразу проверь дубликаты по player_id. И посмотри describe() по spending, sessions, level.",
        },
        {
          "speaker": "sergey",
          "text": "О, игроки! Глянь распределение level. Догадываюсь, что до 10 доходят единицы. Как хардкорные RPG 😄",
        },
      ]
,
...
[
        {
          "speaker": "me",
          "text": "Пропуски в spending и sessions. Удалять или заполнять?",
        },
        {
          "speaker": "galina",
          "text": "spending — заполни медианой по гильдии. sessions — средним. level > 100 — явно читерство, удали строки.",
        },
        {
          "speaker": "viktor",
          "text": "А вдруг spending=NaN значит, что игрок — философ? Он не тратит, он познаёт мир игры. Ну, или баг. Удали.",
        },
      ]
,
...
[
        {
          "speaker": "me",
          "text": "Почистил. Что смотреть в EDA?",
        },
        {
          "speaker": "galina",
          "text": "Гистограмму spending и sessions, scatter level vs spending, boxplot churn по гильдиям. Проверь balance target.",
        },
        {
          "speaker": "stepan",
          "text": "Сделай distribution spending с цветом по churn. Цвета подбери — чтоб и дальтоник понял!",
        },
      ]
,
...
[
        {
          "speaker": "me",
          "text": "Фичи создавать? Какие? У меня 15 колонок.",
        },
        {
          "speaker": "galina",
          "text": "avg_session_time, spending_per_level, has_guild (бинарный), days_since_last_session — если есть дата.",
        },
        {
          "speaker": "igor",
          "text": "Можешь не заморачиваться — Random Forest сам отберёт важные. Но avg_session_time точно пригодится.",
        },
      ]
,
...
[
        {
          "speaker": "me",
          "text": "Корреляции: spending и sessions связаны. Это норм?",
        },
        {
          "speaker": "galina",
          "text": "Логично: кто тратит — тот играет больше. Проверь VIF на мультиколлинеарность, если будешь линейную модель делать.",
        },
      ]
,
...
[
        {
          "speaker": "me",
          "text": "ML задача — churn prediction. Какую модель взять?",
        },
        {
          "speaker": "galina",
          "text": "RandomForestClassifier — best practice. LogisticRegression как baseline. stratify=y, 80/20.",
        },
        {
          "speaker": "sergey",
          "text": "Random Forest — как выбрать персонажа: универсально и надёжно. Не имба, но в любой сборке заходит",
        },
      ]
,
...
[
        {
          "speaker": "me",
          "text": "Обучил RF: accuracy 83%. Хорошо или плохо?",
        },
        {
          "speaker": "galina",
          "text": "Разрыв 8% — норм. Смотри confusion_matrix: FP (кого зря удерживаем) vs FN (кого упустили).",
        },
        {
          "speaker": "igor",
          "text": "83% — так себе. Но для первого раза терпимо. В production поднимем",
        },
      ]
,
  ...
  {
  "step": 9,
  "title": "Финальная визуализация",
  "dialogue": 
[
        {
          "speaker": "me",
          "text": "Recall 0.75 — упускаем 25% уходящих. Как поднять?",
        },
        {
          "speaker": "galina",
          "text": "Сдвинь порог до 0.4 — пожертвуешь precision ради recall. Для churn лучше удержать лишнего, чем упустить платящего.",
        },
      ]
,
...
[
        {
          "speaker": "me",
          "text": "Feature importance: sessions_per_day, spending, level.",
        },
        {
          "speaker": "galina",
          "text": "sessions_per_day и spending — логично: активные и платящие не уходят. level важен, но слабее.",
        },
        {
          "speaker": "igor",
          "text": "Конечно, кто до 50 дошел — тот не уйдет. Потраченного времени жалко. Как я в Elden Ring — 200 часов, бросить невозможно",
        },
      ]
,
  ...
  "step": 99,
  "title": "Интерпретация результатов",
  "task": "Опиши 3 главных вывода по оттоку игроков. Какие фичи важнее всего?",
  "code": "",
  "hints": ["Вспомни, что мы обсуждали на предыдущих шагах", "Посмотри на данные с точки зрения продукта", "Не бойся просить уточнения у коллег"],
  "lessons": [],
  "dialogue": 
[
        {
          "speaker": "me",
          "text": "Три вывода: активность важнее трат, гильдия удерживает.",
        },
        {
          "speaker": "galina",
          "text": "Выводы: (1) Активность — главный anti-churn. (2) Гильдия удерживает. (3) Первые 3 дня — критические.",
        },
        {
          "speaker": "sergey",
          "text": "Гильдия — как клан в WoW. Новичок в гильдии = ни за что не уйдёт. Социализация рулит!",
        },
        {
          "speaker": "stepan",
          "text": "Может, гильдия работает из-за красивого интерфейса? У нас там анимация вступления — огонь!",
        },
      ]
,
},
  ...
  "step": 99,
  "title": "Визуализация: дашборд",
  "task": "Построй дашборд оттока: churn по неделям, scatter трат-сессий, влияние гильдии.",
  "code": "",
  "hints": ["Вспомни, что мы обсуждали на предыдущих шагах", "Посмотри на данные с точки зрения продукта", "Не бойся просить уточнения у коллег"],
  "lessons": [],
  "dialogue": 
[
        {
          "speaker": "me",
          "text": "Дашборд для команды: churn по сегментам?",
        },
        {
          "speaker": "stepan",
          "text": "Plotly — возьми scatter spending vs sessions с цветом churn. Добавь тепловую карту level/guild. Будет бомба!",
        },
        {
          "speaker": "sergey",
          "text": "Сделай круговую: кто ушёл до 7 дней. Это будет как экран поражения в Dark Souls — больно, но мотивирует",
        },
      ]
,
},
  ...
  "step": 99,
  "title": "Отчёт README",
  "task": "Напиши README-отчёт: задача → EDA → модель → результаты → рекомендации команде.",
  "code": "",
  "hints": ["Вспомни, что мы обсуждали на предыдущих шагах", "Посмотри на данные с точки зрения продукта", "Не бойся просить уточнения у коллег"],
  "lessons": [],
  "dialogue": 
[
        {
          "speaker": "me",
          "text": "Пишу README-отчёт. Что включить?",
        },
        {
          "speaker": "galina",
          "text": "Добавь бизнес-рекомендации: что делать команде. Например: усилить онбординг, улучшить гильдии, акции для 3-го дня.",
        },
        {
          "speaker": "viktor",
          "text": "В раздел дальнейшие шаги напиши изучить квантовую природу оттока. Команда оценит глубину мысли. Или нет",
        },
      ]
,
},
  ...
  "step": 99,
  "title": "Подготовка к защите",
  "task": "Подготовь презентацию для команды: 5 слайдов о модели churn и бизнес-выводах.",
  "code": "",
  "hints": ["Вспомни, что мы обсуждали на предыдущих шагах", "Посмотри на данные с точки зрения продукта", "Не бойся просить уточнения у коллег"],
  "lessons": [],
  "dialogue": 
[
        {
          "speaker": "me",
          "text": "Защита завтра. Волнуюсь — вдруг спросят про A/B тесты?",
        },
        {
          "speaker": "galina",
          "text": "Будь готова объяснить, почему твоя модель полезна продакту. Какие метрики бизнеса улучшит?",
        },
        {
          "speaker": "igor",
          "text": "Волноваться нормально. Я перед каждым релизом волнуюсь. А потом всё работает... или нет. Но ты справишься",
        },
      ]
,
},
...
[
        {
          "speaker": "me",
          "text": "Босс, готово! Модель churn, дашборд, рекомендации команде.",
        },
        {
          "speaker": "client",
          "text": "Супер! Модель 83% accuracy — хорошо. Рекомендации дельные — возьмём в работу. Принимаю! Отличная работа.",
        },
        {
          "speaker": "galina",
          "text": "Поздравляю! Быстро втянулась. Теперь ты полноценный DS в команде.",
        },
        {
          "speaker": "sergey",
          "text": "Есть! Первый churn-проект закрыт. Ты прокачала уровень! Как после босса — опыта вагон",
        },
        {
          "speaker": "igor",
          "text": "Работа сделана. Можешь выдохнуть. До следующего спринта, конечно. Но сегодня — отдыхай",
        },
        {
          "speaker": "stepan",
          "text": "Красивый дашборд! Если захочешь — научу Figma, будет ещё круче",
        },
      ]
,
},
...
FINAL_PROJECTS = [
    {
        ...
        "characters_json": [
            {"id":"client","name":"Заказчик","emoji":"🧑‍💼","color":"#6c5ce7","role":"Космическое агентство"},
            {"id":"me","name":"Я","emoji":"🧑‍💻","color":"#00b894","role":"Data Scientist"},
            {"id":"alexey","name":"Весёлый Лёха","emoji":"🤩","color":"#fdcb6e","role":"Космический энтузиаст"},
            {"id":"malder","name":"Мрачный Малдер","emoji":"🕵️","color":"#636e72","role":"Конспиролог"},
            {"id":"dmitry","name":"Озабоченный Дима","emoji":"🫡","color":"#e17055","role":"Эксперт по отношениям"},
            {"id":"scully","name":"Научная Скалли","emoji":"🔬","color":"#0984e3","role":"Научный руководитель"},
        ],
    },
    {
        "theme": "gaming",
        ...
        "characters_json": [
            {"id":"client","name":"Заказчик","emoji":"🧑‍💼","color":"#6c5ce7","role":"Product Manager"},
            {"id":"me","name":"Я","emoji":"🧑‍💻","color":"#00b894","role":"Data Scientist"},
            {"id":"sergey","name":"Серёжа-геймер","emoji":"🎮","color":"#e17055","role":"PvP-энтузиаст"},
            {"id":"galina","name":"Продуктивная Галя","emoji":"📊","color":"#0984e3","role":"Product Owner"},
            {"id":"igor","name":"Мрачный Игорь","emoji":"💻","color":"#636e72","role":"Backend Developer"},
            {"id":"stepan","name":"Дизайнер Стёпка","emoji":"🎨","color":"#fdcb6e","role":"UI/UX Designer"},
            {"id":"viktor","name":"Странный Витя","emoji":"🧠","color":"#00b894","role":"QA Engineer"},
        ],
    },
]
