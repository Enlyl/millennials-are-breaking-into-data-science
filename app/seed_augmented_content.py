    ...
    return lesson(
        "11.2", "Космос: проект — анализ миссий NASA", "space", [
            theory(
                ...
                "**Структура проекта:** 10 шагов — от бизнес-задачи до сдачи "
            ...
            example(
                "Открой проект и пройди все 10 шагов последовательно. "
                "На каждом шаге — диалог с Заказчиком и задание.",
                "Шаг 1: Заказчик объясняет задачу. Ты уточняешь метрики. "
                "Шаг 2: Загружаешь данные. И так до финального отчёта.",
            ...
            interview_questions([
                {"q": "Какой проект ты делал в курсе?", "a": "Финальный проект по анализу космических миссий NASA: 10 шагов, от бизнес-задачи до ML-модели и отчёта. Использовал Random Forest, accuracy 87%."},
            ]),
            knowledge_checklist([
                "Понимаю бизнес-задачу: прогноз успеха миссии",
                "Могу объяснить подход: EDA → Feature Engineering → Random Forest",
                "Готов пройти 10 шагов проекта",
            ]),
        ],
        exercises=[
    ...
    return lesson(
        "11.3", "Игры: проект — анализ поведения игроков", "gaming", [
            theory(
                ...
                "**Структура проекта:** 10 шагов — от бизнес-задачи до "
            ...
            example(
                "Открой проект и пройди все 10 шагов. Каждый шаг — "
                "диалог с гейм-директором и практическое задание.",
            ...
            interview_questions([
                {"q": "Расскажи про проект по анализу игроков", "a": "Финальный проект: прогноз оттока игроков (churn). 10 шагов от бизнес-задачи до рекомендаций. Random Forest — accuracy 85%. Ключевой фактор: количество сыгранных дней."},
            ]),
            knowledge_checklist([
